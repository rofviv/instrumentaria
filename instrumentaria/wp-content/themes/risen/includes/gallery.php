	...
	register_post_type(
		...
		array(
			'labels' 	=> array(
				...
				'add_new' 				=> _x( 'Add New', 'gallery', 'risen' ),
				'add_new_item' 			=> __( 'Add Gallery Item', 'risen' ),
				'edit_item' 			=> __( 'Edit Gallery Item', 'risen' ),
				'new_item' 				=> __( 'New Gallery Item', 'risen' ),
				'all_items' 			=> _x( 'All Items', 'gallery', 'risen' ),
				'view_item' 			=> __( 'View Gallery Item', 'risen' ),
				'search_items' 			=> __( 'Search Gallery Items', 'risen' ),
				'not_found' 			=> __( 'No gallery items found', 'risen' ),
				'not_found_in_trash' 	=> __( 'No gallery items found in Trash', 'risen' )
			),
			'public' 			=> true,
			'has_archive' 		=> false,
