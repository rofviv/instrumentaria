...
if ( ! function_exists( 'optionsframework_page_notice' ) ) {
    ...
    function optionsframework_page_notice() {
		...
		add_thickbox(); // so can load plugin information in lightbox
	
		$screen_icon = screen_icon( 'themes' );	
		$title = __( 'Theme Options', 'risen' );
		$plugin_url = admin_url( 'plugin-install.php?tab=plugin-information&plugin=options-framework&TB_iframe=true&width=700&height=450' );;
...
echo <<< HTML
        ...
        <div class="wrap">
			...
			<p>
				<b>Please install the <a href="$plugin_url" class="thickbox onclick">Options Framework</a> plugin to use the theme options.</b> 
...
if ( ! function_exists( 'optionsframework_options' ) ) {
	...
	function optionsframework_options() {
		...
		$options[] = array(
			...
			$options[] = array(
				"name" 	=> __( 'Homepage &lt;title&gt;', 'risen' ),
				"desc" 	=> sprintf( __( 'You can tweak the homepage &lt;title&gt; tag for SEO. [site_name] and [tagline] are replaced by what you entered in WordPress <a href="%s">General Settings</a>.', 'risen' ), admin_url( 'options-general.php' ) ),
				"id" 	=> "custom_home_title",
				"std" 	=> risen_option_default( 'custom_home_title' ),
				"type" 	=> "text",
				"class"		=> "risen-option-wide"
			);
		...
		$options[] = array(
			...
			$options[] = array(
				"name" 	=> _x( 'reCAPTCHA Public Key', 'recaptcha', 'risen' ),
			...
			$options[] = array(
				"name" 	=> _x( 'reCAPTCHA Private Key', 'recaptcha', 'risen' ),
		...
		$options[] = array(
			...
			$options[] = array(
				"name" 	=> __( 'Subpage &lt;title&gt;', 'risen' ),
				"desc" 	=> __( 'You can tweak the subpage &lt;title&gt; tag (blog posts, 404 page). [site_name] and [page_title] are replaced accordingly.', 'risen' ),
				"id" 	=> "custom_subpage_title",
				"std" 	=> risen_option_default( 'custom_subpage_title' ),
				"type" 	=> "text",
				"class"		=> "risen-option-wide"
			);
			...
			$options[] = array(
				...
				"desc" 	=> __( 'Optionally provide a <a href="http://code.google.com/apis/maps/documentation/javascript/tutorial.html#api_key" target="_blank">Google Maps API Key</a>.', 'risen' ),
				"id" 	=> "gmaps_api_key",
				"std" 	=> '',
				"type" 	=> 'text',
				"class"		=> "risen-option-wide"
...
TEXT;
		...
		$defaults['footer_copyright']					= 'Copyright [copyright_symbol] [current_year] [site_name]. Powered by <a href="http://churchthemes.com" title="Church WordPress Themes">churchthemes.com</a>.';
