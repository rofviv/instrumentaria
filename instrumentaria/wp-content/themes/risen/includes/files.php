...
function risen_force_download() {
	...
	$file_extensions = apply_filters( 'risen_downloadable_file_extensions', $file_extensions ); // allow filtering
 ...
 * Note that file must be in uploads folder and extension must be defined in risen_force_download()
