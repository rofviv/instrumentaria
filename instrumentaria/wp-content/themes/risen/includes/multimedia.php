...
function risen_multimedia_options_meta_box_html( $object, $box ) {
	...
	<p>
		...
		<div class="risen-meta-value">
			<input type="text" name="<?php echo $meta_key; ?>" id="<?php echo $meta_key; ?>" value="<?php echo esc_attr( get_post_meta( $object->ID, $meta_key, true ) ); ?>" size="30" />
			<input type="button" value="Upload MP3" class="upload_button button risen-upload-file" />
			<p class="description">
	...
	<p>
		...
		<div class="risen-meta-value">
			<input type="text" name="<?php echo $meta_key; ?>" id="<?php echo $meta_key; ?>" value="<?php echo esc_attr( get_post_meta( $object->ID, $meta_key, true ) ); ?>" size="30" />
			<input type="button" value="Upload PDF" class="upload_button button risen-upload-file" />
			<p class="description">
				...
				<header>
					...
					<div>
						...
						<ul class="multimedia-widget-item-icons risen-icon-list">
							...
							<li><a href="<?php the_permalink(); ?>" class="single-icon video-icon" title="<?php esc_attr_e( 'Video', 'risen' ); ?>"><?php _e( 'Video', 'risen' ); ?></a></li>
							<?php endif; ?>
							
							<?php if ( risen_multimedia_url( $post->ID, 'audio' ) ) : ?>
							<li><a href="<?php the_permalink(); ?>#play-audio" class="single-icon audio-icon" title="<?php esc_attr_e( 'Audio', 'risen' ); ?>"><?php _e( 'Audio', 'risen' ); ?></a></li>
							<?php endif; ?>
