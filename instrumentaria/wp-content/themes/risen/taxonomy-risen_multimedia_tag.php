<?php
/*
 * Multimedia Tag Taxonomy Template
 *
...
// Taxonomy term
$term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); // tag slug
	...
	<div id="content-inner"<?php if ( risen_sidebar_enabled( 'multimedia', $tpl_page_id ) ) : ?> class="has-sidebar"<?php endif; ?>>
		...
		<section>
			...
			<header class="title-with-right">
				<h1 class="page-title">
					<?php
					$title = str_ireplace( '[tag]', $term->name, risen_option( 'multimedia_tag_title' ) ); // title format from Theme Options
