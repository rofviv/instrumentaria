<?php
/*
 * Multimedia Speaker Taxonomy Template
 *
...
// Taxonomy term
$term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); // speaker slug
	...
	<div id="content-inner"<?php if ( risen_sidebar_enabled( 'multimedia', $tpl_page_id ) ) : ?> class="has-sidebar"<?php endif; ?>>
		...
		<section>
			...
			<header class="title-with-right">
				<h1 class="page-title">
					<?php
					$title = str_ireplace( '[speaker]', $term->name, risen_option( 'multimedia_speaker_title' ) ); // title format from Theme Options
