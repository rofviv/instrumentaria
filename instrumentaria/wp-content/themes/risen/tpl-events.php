...
// Get events happening today or later
...
$events_query = new WP_Query( array(
	...
	'meta_key' 			=> '_risen_event_start_date', // want earliest starting date first
	'orderby'			=> 'meta_value',
...
<div id="content">
	...
	<div id="content-inner"<?php if ( risen_sidebar_enabled( 'events' ) ) : ?> class="has-sidebar"<?php endif; ?>>
		...
		<section>
			...
			<?php risen_posts_nav( $events_query, __( '<span>&larr;</span> Sooner Events', 'risen' ), __( 'Later Events <span>&rarr;</span>', 'risen' ) ); ?>
