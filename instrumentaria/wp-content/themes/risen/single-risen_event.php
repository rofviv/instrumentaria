...
<div id="content">
	...
	<div id="content-inner"<?php if ( risen_sidebar_enabled( 'events' ) ) : ?> class="has-sidebar"<?php endif; ?>>
		...
		<nav class="nav-left-right" id="event-single-nav">
			<div class="nav-left"><?php next_post_link( '%link', __( '<span>&larr;</span> Previous Event', 'risen' ) ); ?></div>
			<div class="nav-right"><?php previous_post_link( '%link', __( 'Next Event <span>&rarr;</span>', 'risen' ) ); ?></div>
			<div class="clear"></div>
		</nav>
